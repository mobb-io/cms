...
# ** however this is a core app so we're using the default settings.
# ** Don't use this key in any non-core usage!
...
WAGTAIL_SITE_NAME = 'Vidraçaria Piratininga'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://192.168.99.100:6379",
        "KEY_PREFIX": "cms",
        "OPTIONS": {
